                            ...
                            hw_device_t** device)
{
    ...
    ladev->device.open_input_stream = adev_open_input_stream; //TEMPORARY WORKAROUND
    //ladev->device.close_input_stream = adev_close_input_stream; //AKA HORRIBLE HACK I WROTE
